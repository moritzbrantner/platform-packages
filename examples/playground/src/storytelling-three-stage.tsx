...
import { type StoryRenderProps, type StoryThreeSceneProps } from "@moritzbrantner/storytelling";
...
function BeaconScene({ node }: StoryThreeSceneProps<StoryVisualData>) {
  ...
  return (
    <>
      ...
      <mesh ref={ringRef} scale={2.25}>
        ...
        <meshStandardMaterial color="#dbeafe" emissive="#93c5fd" emissiveIntensity={0.45} />
      </mesh>
...
export function StoryThreeStageRenderer(
  ...
  const node = {
    ...props.node,
    threeScene: BeaconScene,
  };

  return <StoryCanvasStage {...props} node={node} />;
}
