...
import { DashboardScreen, DetailScreen, FormScreen, PublicScreen, WorkbenchScreen } from "../../src";
    ...
    render(
      <>
        ...
        <FormScreen
          ...
          sections={[{ id: "form", content: <label htmlFor="email">Email<input id="email" /></label> }]}
        />
      </>,
    );
