...
export type UnconditionalImageGenerationInput =
  UniversalTaskInput<"unconditional-image-generation">;
export type UnconditionalImageGenerationOutput =
  UniversalTaskOutput<"unconditional-image-generation">;
export type UnconditionalImageGenerationRequest<Input = UnconditionalImageGenerationInput> =
  UniversalTaskRequest<"unconditional-image-generation", Input>;
export type UnconditionalImageGenerationResult<Output = UnconditionalImageGenerationOutput> =
  UniversalTaskResult<"unconditional-image-generation", Output>;
