...
export type ImageTo3DRequest<Input = ImageTo3DInput> = UniversalTaskRequest<"image-to-3d", Input>;
export type ImageTo3DResult<Output = ImageTo3DOutput> = UniversalTaskResult<"image-to-3d", Output>;
...
export function createImageTo3DPipeline<Input = ImageTo3DInput, Output = ImageTo3DOutput>(
